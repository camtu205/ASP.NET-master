        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationPerSession = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerTreatments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerTreatments_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerTreatments_Treatments_TreatmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CustomerTreatmentId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TreatmentSessions_CustomerTreatments_CustomerTreatmentId",
                        column: x => x.CustomerTreatmentId,
                        principalTable: "CustomerTreatments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TreatmentSessions_Staffs_StaffId",
                        column: x => x.StaffId,
                        principalTable: "Staffs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerTreatments_CustomerId",
                table: "CustomerTreatments",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerTreatments_TreatmentId",
                table: "CustomerTreatments",
                column: "TreatmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentSessions_CustomerTreatmentId",
                table: "TreatmentSessions",
                column: "CustomerTreatmentId");

            migrationBuilder.CreateIndex(
                name: "IX_TreatmentSessions_StaffId",
                table: "TreatmentSessions",
                column: "StaffId");
